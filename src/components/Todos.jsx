        ...
        <>
            ...
            <ul className='list-none '>
                {todos.map((todo) => (
                    ...
                    <li
                        className='mt-4 w-[1000px] flex justify-between items-center bg-zinc-800 px-4 py-2 rounded'
                        key={todo.id}>
...

                        {
                            editingId === todo.id ? (
                                <input
                                    ...
                                    className={`text-black rounded p-1 ${todo.completed ? "line-through" : ""}`}
                                />
                        ...
                        <div className='flex gap-5'>
                            <div className='text-white flex items-center' >{todo.date}</div>
                            {
                                editingId === todo.id ? (
                                    <button
